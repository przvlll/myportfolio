...
import baguioVideo from "../assets/baguio7.mp4";
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 overflow-y-auto">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4 leading-tight">
              <span className="text-indigo-600">Day 7: </span>Burnham Park Bike Ride
            </h1>
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            <p>
              This video was taken by me while I was riding a four-wheeler bike
              in the Burnham Biking Area at Burnham Park, Baguio City, Benguet,
              during day 7 of our educational tour (April 13, 2025). It was
              early in the morning, and the air was crisp and cool—typical of
              Baguio’s refreshing climate. The biking area was full of life,
              with students, families, and tourists enjoying their rides and
              laughter echoing through the park.
            </p>

            <p>
              As I pedaled through the path surrounded by tall pine trees and
              open space, I felt a genuine sense of freedom and joy. It was a
              simple moment, yet memorable—an experience that balanced the
              fast-paced nature of our industry visits with pure fun and
              relaxation. Riding the bike made me feel like a kid again,
              carefree and present in the moment.
            </p>

            <p>
              Burnham Park, especially the biking area, gave me a taste of what
              it means to enjoy the little things in life while still being part
              of something bigger—like our journey as IT students exploring the
